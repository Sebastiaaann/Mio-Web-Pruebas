...
const handleLoginSubmit = async () => {
  ...
  // Validar RUT
  if (!validateRut(loginForm.value.rut)) {
    loginError.value = "RUT inválido";
    return;
  }
...
<template>
  <!-- Main Container -->
  <div
    class="min-h-screen w-full flex flex-col relative overflow-hidden transition-colors duration-300 font-sans"
    :class="[
      isDark ? 'bg-[#1A1033] text-[#F3F4F6]' : 'bg-[#FDFBFF] text-[#1F2937]',
    ]"
  >
    <!-- Background Gradients (Animated) -->
    <div class="absolute inset-0 pointer-events-none z-0">
      <div
        class="absolute inset-0 bg-gradient-custom transition-opacity duration-1000"
      ></div>
    </div>
    ...
    >
      <div
        class="max-w-7xl w-full grid grid-cols-1 lg:grid-cols-2 gap-12 items-center"
      >
        <!-- Left Column: Text Content -->
        <div class="flex flex-col items-start space-y-8 max-w-lg">
          <div class="space-y-2">
            <h1
              class="text-6xl font-bold text-[#8B5CF6] tracking-tight flex items-start"
            >
              Mio
          ...
          >
            <button
              class="hover:text-[#8B5CF6] transition-colors hover:underline"
            >
        ...
        <div
          class="hidden lg:flex justify-center items-center relative h-[500px] w-full select-none pointer-events-none"
        >
          <!-- Floating Elements Animation -->
          <div class="absolute z-20 animate-float">
            <div
              class="w-24 h-24 rounded-full flex items-center justify-center backdrop-blur-sm shadow-xl border"
              :class="
                isDark
                  ? 'bg-[#8B5CF6]/30 border-white/10'
                  : 'bg-[#8B5CF6]/20 border-white/50'
              "
            >
              <div
                class="w-16 h-16 bg-[#8B5CF6] rounded-full flex items-center justify-center shadow-inner"
              >
                <svg
            ...
            <div
              class="absolute -bottom-8 left-1/2 -translate-x-1/2 whitespace-nowrap text-[10px] tracking-widest font-bold uppercase"
          ...
          <div class="absolute -top-10 right-1/3 animate-float-delayed">
            <div
              class="w-16 h-16 rounded-full flex items-center justify-center shadow-lg border z-10 relative"
              :class="
                isDark
                  ? 'bg-[#2D1B4E] border-gray-700'
          ...
          <div class="absolute bottom-20 left-20 animate-float-delayed-2">
            <div
              class="w-20 h-20 rounded-full flex items-center justify-center shadow-lg border z-10 relative"
              :class="
                isDark
                  ? 'bg-[#2D1B4E] border-gray-700'
                  : 'bg-white border-gray-100'
            ...
            >
              <div
                class="w-10 h-8 rounded md:rounded-lg"
                :class="isDark ? 'bg-gray-800' : 'bg-gray-100'"
              ></div>
            </div>
          </div>
          ...
          <div class="absolute bottom-32 right-20 animate-float">
            <div
              class="w-18 h-18 rounded-full p-4 flex items-center justify-center shadow-lg border z-10 relative"
              :class="
                isDark
                  ? 'bg-[#2D1B4E] border-gray-700'
                  : 'bg-white border-gray-100'
          ...
          <svg
            ...
            viewBox="0 0 400 400"
            :class="isDark ? 'opacity-10' : 'opacity-20'"
          >
            <line
              class="text-[#8B5CF6]"
              stroke="currentColor"
      ...
      >
        ...
        >
          ...
          <div class="flex flex-col items-center mb-8">
            <div class="mb-6 relative">
              <div class="w-32 h-32 flex items-center justify-center relative">
                ...
                />
                <div
                  class="absolute -right-2 -bottom-2 p-2 rounded-full shadow-md border bg-white dark:bg-gray-800 border-purple-50 dark:border-gray-700"
                >
                  <span
                    class="text-[#8B5CF6] text-xl font-bold material-icons-round"
                  >
          ...
          >
            <div class="space-y-1">
              <label
                class="block text-sm font-medium ml-1"
              ...
              <div class="relative">
                ...
                <input
                  ...
                  :class="
                    isDark
                      ? 'bg-gray-800 border-gray-600 text-[#F3F4F6]'
            ...
            <div class="mt-4 text-center">
              ...
              >
                ...
                <button
                  ...
                  class="text-[#8B5CF6] font-semibold hover:underline"
                >
                  Inicia sesión
                </button>
              </p>
            ...
            <form v-else @submit.prevent="handleLoginSubmit" class="space-y-4 pt-2">
               <PremiumInput
                 ...
                 @update:modelValue="val => loginForm.rut = formatRutOnInput(val)"
                 :error="loginError && loginError.includes('RUT') ? 'RUT Inválido' : ''"
                 :success="validateRut(loginForm.rut)"
               />
               ...
               <PremiumInput
                 ...
                 :error="loginError && !loginError.includes('RUT') ? loginError : ''"
               />
          ...
          <div class="mt-8 text-center">
            <p class="text-xs text-gray-400 dark:text-gray-500">
              <span class="font-bold text-purple-400"
                >Mio<sup class="text-[0.6em] top-[-0.3em]">+</sup></span
              >
              una marca de
